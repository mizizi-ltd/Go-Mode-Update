...
const RouteEngine = (() => {
  ...
  const initLeafletMap = () => {
    ...
    // Soft shadow line underneath for subtle depth on the pastel street trails
    ...
    // Draw individual gradient-colored dashed segments following actual Arusha streets
    const segmentLayers = [];
